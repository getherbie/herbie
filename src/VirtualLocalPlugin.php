...
final class VirtualLocalPlugin extends Plugin
{
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathConsoleCommands');
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathEventListeners');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathInterceptingFilters');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathApplicationMiddlewares');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathRouteMiddlewares');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathTwigFilters');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathTwigGlobals');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathTwigFunctions');
        $files = $this->findPhpFilesInDir($dir);
    ...
    {
        $dir = $this->application->getConfig()->getAsString('plugins.virtual_local_plugin.pathTwigTests');
        $files = $this->findPhpFilesInDir($dir);
